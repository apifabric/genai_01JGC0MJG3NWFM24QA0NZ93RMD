...
resourcename="dogwalkersystem"  # lower case, only
resourcegroup="dogwalkersystem_rg"
...
# git clone https://github.com/apilogicserver/dogwalkersystem.git
# cd dogwalkersystem
...
az group create --name dogwalkersystem_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group dogwalkersystem_rg --sku S1 --is-linux
az container create --resource-group dogwalkersystem_rg --name dogwalkersystem --image apilogicserver/dogwalkersystem:latest --dns-name-label dogwalkersystem --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//dogwalkersystem.westus.azurecontainer.io:5656'
